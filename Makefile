...
build-sample-ios:
	(cd sample/ACP*Sample/ios && xcodebuild build -project ACPAudienceSample.xcodeproj -scheme ACPAudienceSample CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED="NO" CODE_SIGNING_ALLOWED="NO")
