...
public class RCTACPAudienceArrayUtil {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            switch (type) {
                ...
                case String:
                    ...
                    break;
                case Map:
                    array[i] = RCTACPAudienceMapUtil.toMap(readableArray.getMap(i));
                    break;
                case Array:
                    array[i] = RCTACPAudienceArrayUtil.toObjectArray(readableArray.getArray(i));
                    break;
            }
        }
    ...
    public static WritableArray toWritableArray(Object[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            if (value == null) {
                ...
                writableArr.pushMap(RCTACPAudienceMapUtil.toWritableMap((Map<String, String>) value));
            } else if (value.getClass().isArray()) {
                writableArr.pushArray(RCTACPAudienceArrayUtil.toWritableArray((Object[]) value));
            }
        }
